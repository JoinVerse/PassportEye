...
class MRZ(object):
    ...
    def _parse_td2_fr(self, a, b):
        ...
        self.names, reduced_score_names = self.parse_french_names(b[13:27])
        self.date_of_birth, reduced_score_dob = self.force_conversion(b[27:33], False)
        self.sex = b[34]
        self.nationality = 'FRA'
        self.optional1 = 'NA'
        self.optional2 = 'NA'
        self.number, reduced_score_number = self.force_conversion(b[0:13], False)
        ...
        self.valid_score -= (reduced_score_dob + reduced_score_names + reduced_score_number + reduced_score_surnames)
